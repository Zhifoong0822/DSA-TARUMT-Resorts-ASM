...
public class VipRoomAllocationDAO {
    ...
    public PriorityBinarySearchTreeInterface<LoyaltyRoomRequest> loadWaitingRequests() {
        ...
        tree.add(new LoyaltyRoomRequest("RQ1001", "Alicia Wong", "Platinum", "Penthouse", 3, 3600.00, 1));
        tree.add(new LoyaltyRoomRequest("RQ1002", "Bryan Lim", "Platinum", "Deluxe", 2, 600.00, 2));
        tree.add(new LoyaltyRoomRequest("RQ1003", "Chloe Tan", "Diamond", "Suite", 4, 3200.00, 3));
        tree.add(new LoyaltyRoomRequest("RQ1004", "Daniel Lee", "Elite", "Deluxe", 1, 300.00, 4));
